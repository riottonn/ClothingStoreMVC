...
namespace ClothingStore.Infrastructure.Controllers
{
    public class OrdersController : Controller
    {
        ...
        {
            var clothingStoreContext = _context.Orders.Include(o => o.Customer);
        ...
        public async Task<IActionResult> Create([Bind("OrderDate,CustomerId,TotalAmount,Id")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderDate,CustomerId,TotalAmount,Id")] Order order)
        {
            if (id != order.Id)
            {
                return NotFound();
